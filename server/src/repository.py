...
PRIVACY_CONST_INV = {v: k for k, v in PRIVACY_CONST.items()}
...
class User(db.Model, UserMixin):
    ...
    def __init__(self, email, username, password, global_privacy=PRIVACY_CONST_INV['private'], active=None, roles=None):
        self.email = email
